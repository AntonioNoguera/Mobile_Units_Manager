...
class inicio_turno_empleado : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Se declara la altura del container

        val heightA = (resources.displayMetrics.heightPixels * 0.50).toInt()
        val layo = binding.contenedor.layoutParams

        layo.height=heightA

        binding.contenedor.layoutParams=layo
        ...
        binding.dropPlacas.onItemClickListener = AdapterView.OnItemClickListener {
            ...
            //Codigo de cambio de hint
            val usuariosRef = db.collection("automoviles").document(SelectPlacas)
            ...
            usuariosRef.get()
                .addOnSuccessListener { document ->
                    ...
                    if (document.exists()) {
                        ...
                        var kilometraje = datoLeido?.get("stateKilometraje") as String

                        binding.inputKilometraje.hint=kilometraje
                    }
                }
        ...
        binding.btnContinuar.setOnClickListener{
            ...
            if(EstadoNeumaticos=="" || EstadoCarroceria=="" || EstadoLimpieza=="" || binding.inputKilometraje.text.toString()==""){
                ...
                if(binding.inputKilometraje.text.toString().toInt()<=binding.inputKilometraje.hint.toString().toInt()){
                    Toast.makeText(this,"No puedes tener kilometraje mas bajo en los registros.",Toast.LENGTH_SHORT).show()
                }else{
                    //Código del insert
                    ...
                    intent.putExtra("unidad",SelectPlacas)
                    intent.putExtra("nImagen","0")
